...
class Document(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> Document: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...

class WordEmbedding(google___protobuf___message___Message):
    word = ... # type: typing___Text
    embeddingVector = ... # type: google___protobuf___internal___containers___RepeatedScalarFieldContainer[float]

    def __init__(self,
        word : typing___Text,
        embeddingVector : typing___Optional[typing___Iterable[float]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> WordEmbedding: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
